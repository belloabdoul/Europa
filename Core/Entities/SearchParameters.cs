...
namespace Core.Entities
{
    public class SearchParameters
    {
        ...
        [Range(0.7, 1, ConvertValueInInvariantCulture = true, ErrorMessage = "The degree of similarity must be between 0.7 and 1", ParseLimitsInInvariantCulture = true)]
        ...
        public List<string> IncludedFileTypes { get; set; }
